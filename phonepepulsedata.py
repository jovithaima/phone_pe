...
Top_user = pd.DataFrame(table6,columns = ("States", "Years", "Quarter", "Pincodes", "RegisterdUser"))
...
tab1, tab2, tab3 = st.tabs(["***HOME***","***EXPLORATION***","***ANALYSIS***"])
